...
int main()
{
	...
	const int TAILLE_EQUIPE = 10;
	XBotManufacture manufacture;
	XBot** equipe1 = new XBot * [TAILLE_EQUIPE];
	XBot** equipe2 = new XBot * [TAILLE_EQUIPE];

	for (int i = 0; i < TAILLE_EQUIPE; i++) {
		equipe1[i] = manufacture.creerXBot(manufacture.randomRobots());
		equipe2[i] = manufacture.creerXBot(manufacture.randomRobots());
	}

	cout << "Equipe 1:" << endl;
	for (int i = 0; i < TAILLE_EQUIPE; i++) {
		cout << equipe1[i]->toString() << endl;
	}

	cout << "Equipe 2:" << endl;
	for (int i = 0; i < TAILLE_EQUIPE; i++) {
		cout << equipe2[i]->toString() << endl;
	}

	Arene arene;
	arene.setEquipes(equipe1, equipe2);
	arene.debuterCombat();
...
void afficherInformation()
{
	cout << endl << endl;
	cout << endl << "-------------------------------" << endl;
	cout << " NB constructeurs       : " << Compteur::getNbreConstructeurs() << endl;
	cout << " NB constructeurs copie : " << Compteur::getNbreConstructeursCopie() << endl;
	cout << " NB destructeurs        : " << Compteur::getNbreDestructeurs() << endl;
...
void testG990()
{
	...
	cout << "ENERGIE_Physique : " << g990->getEnergiePhysique() << endl;
	cout << "ENERGIE_Maximale : " << g990->getEnergieMaximale() << endl;
